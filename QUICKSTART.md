...
3. **The journal** — `BUILD_JOURNAL.md` at the repo root documents every build day.
4. **The Drift Engine spec** — `DRIFT_ENGINE_README.md` explains the AMINA Challenge 4 approach.
